...
declare type GetClient<Base extends object, C extends RequiredArgs['client'], CP extends RequiredArgs['client']> =
...
declare type GetResultSelect<Base extends object, R extends RequiredArgs['result'][string]> =
  & Base
  & {
    [K in keyof R]?: true;
  };
...
export declare function makeDocument(
  { dmmf, rootTypeName, rootField, select, modelName, extensions }: DocumentInput,
): Document_2;
...
> = {
  result: '$allModels' extends keyof ExtArgs['result'] ? ApplyAllModels extends true ? {
    ...
    : {
      [K in keyof ExtArgs['result'] | keyof PrevExtArgs['result']]: PatchFlat3<
        ExtArgs['result'][K],
...
declare type PatchDeep<O1, O2, O = O1 & O2> =
  & {
    [K in keyof O]: K extends keyof O1
      ? K extends keyof O2 ? O1[K] extends object ? O2[K] extends object ? O1[K] extends Function ? O1[K]
            : O2[K] extends Function ? O1[K]
            : PatchDeep<O1[K], O2[K]>
          : O1[K]
        : O1[K]
      : O1[K]
...
declare namespace Transaction {
  export { Info, IsolationLevel, Options, TransactionHeaders };
}

...
function checkRoundingDigits(d, i, rm, repeating) {
  ...
  if (repeating == null) {
    if (i < 3) {
      ...
      r = (rm < 4 && rd + 1 == k || rm > 3 && rd + 1 == k / 2) && (d[di + 1] / k / 100 | 0) == mathpow(10, i - 2) - 1 ||
    ...
    if (i < 4) {
      ...
      r = ((repeating || rm < 4) && rd + 1 == k || !repeating && rm > 3 && rd + 1 == k / 2) &&
...
function finalise(x, sd, rm, isTruncated) {
  ...
  if (sd != null) {
    ...
    roundUp = rm < 4 ? (rd || isTruncated) && (rm == 0 || rm == (x.s < 0 ? 3 : 2)) : rd > 5 ||
      rd == 5 &&
        (rm == 4 || isTruncated ||

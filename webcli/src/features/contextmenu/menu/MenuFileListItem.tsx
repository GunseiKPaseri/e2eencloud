...
import type { FileInfoFile, FileInfoFolder, FileNode } from '~/features/file/file.type';
...
export default function MenuFileListItem(props: ContextMenuProps<ContextMenuFileListItem>) {
  ...
  const { target } = menu;
  const isInDir = menu.isInDir !== false ? (activeFileGroup && activeFileGroup.type === 'dir') : false;
